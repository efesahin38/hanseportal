...
class SupabaseService {
  ...
  static Future<List<Map<String, dynamic>>> getWorkSessionsPendingApproval({String? departmentId, List<String>? serviceAreaIds}) async {
    ...
    if (serviceAreaIds != null && serviceAreaIds.isNotEmpty) {
      query = query.in_('order.service_area_id', serviceAreaIds) as dynamic;
    }
  ...
  static Future<Map<String, dynamic>> getAccountingSummary({List<String>? serviceAreaIds, String? departmentId}) async {
    ...
    if (serviceAreaIds != null && serviceAreaIds.isNotEmpty) {
      invoicedQ = invoicedQ.in_('order.service_area_id', serviceAreaIds) as dynamic;
      pendingQ = pendingQ.in_('order.service_area_id', serviceAreaIds) as dynamic;
      allPendingQ = allPendingQ.in_('order.service_area_id', serviceAreaIds) as dynamic;
