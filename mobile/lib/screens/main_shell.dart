                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('HansePortal v19.2.9', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'Inter')),
                          const Text('v19.2.9', style: TextStyle(color: Colors.white70, fontSize: 12, fontFamily: 'Inter')),
                        ],
                      ),
                    ),
                  ],
