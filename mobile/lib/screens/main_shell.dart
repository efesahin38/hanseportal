                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('HansePortal v16.5', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'Inter')),
                          const Text('v16.5', style: TextStyle(color: Colors.white70, fontSize: 12, fontFamily: 'Inter')),
                        ],
                      ),
                    ),
                  ],
