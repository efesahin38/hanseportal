    ...
    return Scaffold(
      ...
      body: WebContentWrapper(
        ...
        children: [
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('v19.3.6', style: const TextStyle(color: Colors.white70, fontSize: 12, fontFamily: 'Inter')),
                            if (canCreate) ...[
          ...
          const Text('HansePortal v19.3.6', style: TextStyle(color: AppTheme.textSub, fontSize: 10)),
        ],
      ),
    ),
  );
