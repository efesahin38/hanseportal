    ...
    return Scaffold(
      ...
      body: WebContentWrapper(
        ...
        children: [
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('v1.1.2', style: const TextStyle(color: Colors.white70, fontSize: 12, fontFamily: 'Inter')),
                            if (canCreate) ...[
          ...
          const Text('HansePortal v1.1.2', style: TextStyle(color: AppTheme.textSub, fontSize: 10)),
        ],
      ),
    ),
  );
